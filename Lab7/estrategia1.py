...
#Escenario de Redistribución de Torniquetes
...
def ejecutar_simulacion_redistribucion(numero_personas, tipo_acceso, duracion_simulacion, capacidad_torniquetes):
...
if __name__ == "__main__":
    # Ejemplo de redistribución de torniquetes con capacidad original de 3
    ejecutar_simulacion_redistribucion(numero_personas=300, tipo_acceso='Normal', duracion_simulacion=200, capacidad_torniquetes=3)
