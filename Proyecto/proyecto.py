...
"""
Restriccion 2: No se pueden asignar m ́as doctores a una zona que el total
de doctores que est ́an disponibles para el hospital, indicados en los par ́ametros
iniciales.
